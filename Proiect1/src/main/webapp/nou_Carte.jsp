...
url(&quot;assets/conference/carti.jpg&quot;);">
		<div class="container">
			<div class="row">
				<div class="col-md-5 text-left " style="">
					<h1 class="mb-3">Adaugare Carte</h1>
				</div>
			</div>
		</div>
	</div>
	<div class="py-5" id="modificaautor" style="">
		<div class="container">
            ...
            String DataPublicarii = request.getParameter("DataPublicarii");
            if (Nume != null) {
                jb.connect();
                jb.adaugaCarte(Nume, Gen, DataPublicarii);
                jb.disconnect();
        %>
        ...
        %>
					<form id="c_form-h" class="" action="nou_Carte.jsp" method="post">
...
col-form-label">Numele
							...
							<div class="col-10 col-md-9 offset-md-1">
								<input type="text" class="form-control" name="Nume"
									placeholder="ex_Morometii">
							</div>
						</div>
						<div class="form-group row">
							<label for="Gen" class="col-2 
col-form-label">Genul
								Cartii</label>
							<div class="col-10 col-md-9  offset-md-1">
