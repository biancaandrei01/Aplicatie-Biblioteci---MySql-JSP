...
url(&quot;assets/conference/autori.jpg&quot;);">
		<div class="container">
			<div class="row">
				<div class="col-md-5 text-left " style="">
					<h1 class="mb-3">Modificare Autor</h1>
				</div>
			</div>
		</div>
	</div>
	<div class="py-5" id="modificaautor" style="">
		<div class="container">
            ...
            jb.disconnect();
        %>
					<form id="c_form-h" class="" action="m2_Autor.jsp" method="post">
						<div class="form-group row">
						<label for="idAutor" class="col-2 
col-form-label">IdAutor
						</label>
						<div class="col-10 col-md-9 offset-md-1">
							<input type="text" class="form-control" name="idAutor" value="<%= aux%>" readonly/>
						</div>
						</div>
				<div class="form-group row">
...
col-form-label">Numele
					...
					<div class="col-10 col-md-9 offset-md-1">
						<input type="text" class="form-control" name="Nume" 
							placeholder="ex_Preda" value="<%= Nume%>"/>
					</div>
				</div>
				<div class="form-group row">
...
col-form-label">Prenumele
					...
					<div class="col-10 col-md-9  offset-md-1">
						<input type="text" class="form-control" name="Prenume"
							placeholder="ex_Marin" value="<%= Prenume%>"/>
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-10 col-md-9 offset-md-1">
						<div class="input-group">
							<input type="text" class="form-control" name="DataNasterii"
								placeholder="ex_1999-12-31" value="<%= DataNasterii%>"/>
						</div>
					</div>
				</div>
				<input type="submit" class="btn btn-primary"
					value="Modifica autorul" />
				</form>
