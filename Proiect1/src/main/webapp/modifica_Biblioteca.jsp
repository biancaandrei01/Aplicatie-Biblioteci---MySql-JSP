		...
		<div class="container">
			<div class="row">
				<div class="col-md-5 text-left " style="">
					<h1 class="mb-3">Modificare Tabela Biblioteci</h1>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="table-responsive">
						<form action="m1_Biblioteca.jsp" method="post">
                ...
                %>
					...
					<input href="modifica_Biblioteca" type="submit"
						class="btn btn-lg btn-dark shadowed" value="Modifica liniile selectate">
					<a class="btn btn-lg btn-dark shadowed" href="nou_Biblioteca.jsp">Adauga
						Biblioteca</a>
				</div>
				</form>
				<%
