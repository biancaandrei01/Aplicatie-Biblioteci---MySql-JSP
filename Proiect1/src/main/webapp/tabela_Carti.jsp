    ...
    <div class="container">
      <div class="row">
        <div class="col-md-5 text-left " style="">
          <h1 class="mb-3">Tabela Cartilor</h1>
        </div>
        </div>
  </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <input href="sterge_Carte" type="submit" class="btn btn-lg btn-dark shadowed" value="Sterge liniile selectate">
          <a class="btn btn-lg btn-dark shadowed" href="nou_Carte.jsp">Adauga Carte</a>
          <a class="btn btn-lg btn-dark shadowed" href="modifica_Carte.jsp">Modifica Carte</a>
        </div>
		</p>
 </form> 
 <%
