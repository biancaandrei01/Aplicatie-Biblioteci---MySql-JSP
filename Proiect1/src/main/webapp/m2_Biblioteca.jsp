		...
		<div class="container">
			<div class="row">
				<div class="col-md-5 text-left " style="">
					<h1 class="mb-3">Modificare date selectate</h1>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<%
            jb.connect();
            int aux = java.lang.Integer.parseInt(request.getParameter("idBiblioteca"));
            String idAutor = request.getParameter("idAutor");
            String idCarte = request.getParameter("idCarte");
            String NumeBibl = request.getParameter("Nume");
            String Adresa = request.getParameter("Adresa");

            String[] valori = {idAutor, idCarte, NumeBibl, Adresa};
            String[] campuri = {"idAutor", "idCarte", "Nume", "Adresa"};
            jb.modificaTabela("biblioteci", "idBiblioteca", aux, campuri, valori);
            jb.disconnect();
        %>
					<h1>Datele selectate au fost modificate.</h1>
