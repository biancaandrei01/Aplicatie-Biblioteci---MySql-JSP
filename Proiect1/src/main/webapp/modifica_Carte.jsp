		...
		<div class="container">
			<div class="row">
				<div class="col-md-5 text-left " style="">
					<h1 class="mb-3">Modificare Tabela Carti</h1>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
                ...
                %>
					...
					<input href="modifica_Carte" type="submit"
						class="btn btn-lg btn-dark shadowed"
						value="Modifica liniile selectate"> <a
						class="btn btn-lg btn-dark shadowed" href="nou_Carte.jsp">Adauga
						Carte</a>
				</div>
				</form>
				<%
